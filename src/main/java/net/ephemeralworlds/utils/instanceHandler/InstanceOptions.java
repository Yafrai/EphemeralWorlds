...
//    ModBiome forcedBiome = null;
    ...
    // Create a new island
    public InstanceOptions(PlayerEntity owner, NbtCompound potionTag, LevelInstanceManager manager) {
        this.owner = owner;
        hasExpired = false;
...
//        this.expiration = 3 * 20 * 60;
    ...
    public EnumColor getColor(NbtCompound potionTag) {
        if (potionTag.contains("color")) {
    ...
    protected int getRadiusFromPotion(NbtCompound potionTag) {
    ...
    protected int getLevelFromPotion(NbtCompound potionTag) {
        return 1;
    }
...
//        if (manager.testIslandPlace(0, y, 0, radius)) { todo
        if (false) {
...
//                if (manager.testIslandPlace(x, y, z, radius)) { todo
                if (false) {
    ...
    public InstanceOptions(World world, NbtCompound tag, String suffix) {
...
//    }
    ...
    public NbtCompound writeNbt(NbtCompound tag, String suffix) {
