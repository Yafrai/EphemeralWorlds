...
//
//    public IllusionTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> configDeserializer) {
...
//
//        BlockState logSourceState = StructureResourceBlock.getStateWithVariant(ModBlocks.COLOR_TREE_RESOURCE.getDefaultState(), variant);
