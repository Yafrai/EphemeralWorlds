...
//
//    public ModOreFeature(Function<Dynamic<?>, ? extends OreFeatureConfig> function_1) {
//        super(function_1);
//    }
//
////    @Override
...
////                                            if (test(iWorld_1.getBlockState(blockPos$Mutable_1))) {
...
////        return (block.equals(ModBlocks.COLOR_STONE));
//////        return (block.equals(ModBlocks.COLOR_STONE) || block.equals(ModBlocks.COLOR_DIRT) || block.equals(ModBlocks.COLOR_GRASS));
////    }
//}
