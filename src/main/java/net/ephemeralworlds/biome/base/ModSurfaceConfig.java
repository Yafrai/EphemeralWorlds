...
public class ModSurfaceConfig {
    ...
    public static TernarySurfaceConfig CRYSTAL = getModSurfaceConfig(ModBlocks.TERIUM_BLOCK.getDefaultState(), ModBlocks.XERIUM_BLOCK.getDefaultState(), ModBlocks.GEM_ORE1.getDefaultState());
