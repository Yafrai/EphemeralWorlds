...
public class XeriumPiston extends ModBlock implements BlockEntityProvider {
    ...
    public XeriumPiston(String uname, Block base) {
        super(uname, base);
    ...
    public static boolean isHeadingDownwards(BlockState state) {
        if (!(state.getBlock() instanceof XeriumPiston))
            return false;
