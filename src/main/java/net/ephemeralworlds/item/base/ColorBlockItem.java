...
public class ColorBlockItem extends BlockItem {
    ...
    public NbtCompound getItemTag(ItemStack stack) {
                ...
                if (blockState_1 == null) {
                    ...
                    if (block_1 == blockState_1.getBlock()) {
                        ...
                        if (playerEntity_1 instanceof ServerPlayerEntity) {
                            // todo
//                            Criterions.PLACED_BLOCK.trigger((ServerPlayerEntity)playerEntity_1, blockPos_1, itemStack_1);
                        }
                    }
    ...
    private BlockState placeFromTag(BlockPos blockPos_1, World world_1, ItemStack itemStack_1, BlockState blockState_1) {
        ...
        NbtCompound compoundTag_1 = itemStack_1.getTag();
        if (compoundTag_1 != null) {
            NbtCompound compoundTag_2 = compoundTag_1.getCompound("BlockStateTag");
            StateManager<Block, BlockState> stateFactory_1 = blockState_1.getBlock().getStateManager();
